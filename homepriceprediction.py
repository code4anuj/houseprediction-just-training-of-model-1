...
Original file is located at
    https://colab.research.google.com/drive/1LOn3z3JuYCUFf6KcWhYA1LLpwAvQYkX-

# **" It's a *House price prediction* model developed based on Linear Regression "- Anuj Patel**
"""
